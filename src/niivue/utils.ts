import { ReadonlyMat4, mat4, vec3, vec4 } from 'gl-matrix'
...
export function tickSpacing(mn: number, mx: number): [number, number, number] {
...
export function isRadiological(mtx: ReadonlyMat4): number {
...
export function unpackFloatFromVec4i(val: vec4): number {
