...
export class Niivue {
  ...
  overlays = [] // layers added on top of base image (e.g. masks or stat maps). Essentially everything after volumes[0] is an overlay. So is this necessary?
  deferredVolumes = []
  deferredMeshes = []
   ...
   * }
   */
  onDragRelease = (): void => {} // function to call when contrast drag is released by default. Can be overridden by user
   ...
   * }
   */
  onVolumeAddedFromUrl = (): void => {}
  onVolumeWithUrlRemoved = (): void => {}
   ...
   * }
   */
  onMeshAddedFromUrl = (): void => {}

  // this seems redundant with onMeshLoaded
  onMeshAdded = (): void => {}
  onMeshWithUrlRemoved = (): void => {}
   ...
   * }
   */
  onClipPlaneChange = (): void => {}
  onCustomMeshShaderAdded = (): void => {}
  onMeshShaderChanged = (): void => {}
  onMeshPropertyChanged = (): void => {}
